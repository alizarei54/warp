...
if [[ -n $cpu ]]; then
curl -L -o warpendpoint -# --retry 2 https://raw.githubusercontent.com/alizarei54/warp/main/endip/$cpu
fi
fi
}
...
clear
echo "--------------------------------------------"
echo " ${Purple}Github  ：${pink}github.com/alizarei54"
echo -e "${yellow}By --> alizarei54 ${green}& ${red}jafar4361 * ${blue}t.me/alizarei54 *${rest}"
echo "--------------------------------------------"
echo""
